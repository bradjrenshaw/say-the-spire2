...
/// <summary>
/// Speech handler routing through Tolk (https://github.com/dkager/tolk).
/// Predates Prism and is kept available so users experiencing lag with Prism
/// can switch back and compare. Sits between Prism and SAPI in the auto chain.
/// </summary>
public class TolkHandler : ISpeechHandler
{
    ...
    public bool Detect()
    {
        ...
        {
            Log.Info($"[AccessibilityMod] TolkHandler.Detect failed: {ex.Message}");
            return false;
        }
    }
